#ifndef TA_COMMON_PARALLEL_H
#define TA_COMMON_PARALLEL_H
...
extern int g_n_dimensions, g_n_points;
extern double *g_n_coords;
extern double **g_coord;
extern int **g_point_index;
