...
def filter_missing_backbone(pdb_in, pdb_out):
    ...
    for residue in pdb_residue_list:
        pdb_residues.append( filter(lambda x: x['chain_id'] == residue[0] and x['residue_id'] == residue[2] and x['residue_name'] == residue[1], atoms ) )
...
if __name__ == "__main__":
    ...
    pdbpqr(base_dir, args.pdb_file, args.chains)
